...
@section('container')
    ...
    <div class="col-auto mt-3 posisi-btn">
        <a href="/dashboard/layanan/skp/cetak" class="btn btn-primary" target="_blank"><span data-feather="printer"></span>
            Cetak</a>
        <i class="bi bi-file-pdf"></i>
        <a href="/dashboard/layanan/skp/cetakpdf" class="btn btn-primary" target="_blank"><span
                data-feather="file-text"></span>
            Pdf</a>
    </div>
    <div class="col-3 mt-3">
        <a href="/dashboard/layanan/surat_keterangan_pindah/create" class="btn btn-primary mb-3">Tambah Pengajuan</a>
    </div>
    <div class="card">
                ...
                <tbody>
                    @foreach ($surat_keterangan_pindah as $skp)
                        <tr>
                            ...
                            <td>
                                no/{{ $loop->iteration }}/skp/{{ \Carbon\Carbon::parse($skp->created_at)->format('y') }}
                            </td>
                            <td>{{ $skp->data_penduduk->nama }}</td>
                            <td>{{ $skp->data_penduduk->no_hp }}</td>
                            ...
                            <td>
                                <a href="/dashboard/layanan/surat_keterangan_pindah/{{ $skp->id }}/edit"
                                    class="badge bg-warning"><span data-feather="edit"></span></a>
                                <a href="/dashboard/layanan/surat_keterangan_pindah/{{ $skp->id }}/verifikasi"
                                    class="badge bg-primary"><span data-feather="check-square"></span></a>
                                <form action="/dashboard/layanan/surat_keterangan_pindah/{{ $skp->id }}"
