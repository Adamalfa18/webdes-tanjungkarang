...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"> Tambah Surat Keterangan Terdaftar</h1>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="/dashboard/layanan/surat_keterangan_terdaftar"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input placeholder="Untuk Pengukuran Tanah Dll" type="text"
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="batas_utara" class="form-label">Batas Tanah Utara</label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="batas_selatan" class="form-label">Batas Tanah Selatan</label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="batas_timur" class="form-label">Batas Tanah Timur</label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="batas_barat" class="form-label">Batas Tanah Barat</label>
