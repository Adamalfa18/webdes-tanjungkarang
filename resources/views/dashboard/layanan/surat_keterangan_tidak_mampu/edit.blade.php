...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Ubah Surat Keterangan Tidak Mampu </h1>
    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select data-live-search="true"
                                                ...
                                                @foreach ($data_penduduk as $penduduk)
                                                    @if (old('data_penduduk_id', $sktm->data_penduduk_id) == $penduduk->id)
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            @if ($sktm->poto_ktp)
                                                <div>
                                                    <a href="{{ asset('storage/' . $sktm->poto_ktp) }}" target="_blank">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            @if ($sktm->poto_kk)
                                                <div>
                                                    <a href="{{ asset('storage/' . $sktm->poto_kk) }}" target="_blank">
