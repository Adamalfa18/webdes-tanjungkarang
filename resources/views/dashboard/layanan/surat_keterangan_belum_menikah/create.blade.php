...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"> Tambah Surat Keterangan Belum Menikah </h1>
    </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form mb-5" method="post"
                                action="/dashboard/layanan/surat_keterangan_belum_menikah" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input placeholder="Tujuan Dibuatnya Surat" type="text"
