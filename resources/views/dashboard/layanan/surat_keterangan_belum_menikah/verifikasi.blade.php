...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Verifikasi Surat Keterangan Belum Menikah</h1>
    </div>



    <div class="col-auto">
        <a href="/dashboard/layanan/surat_keterangan_belum_menikah" class="btn btn-success mb-3">Kembali</a>
        <a href="/dashboard/layanan/surat_keterangan_belum_menikah/{{ $skbm->id }}/cetak-surat"
            class="btn btn-primary mb-3" target="_blank"><span data-feather="printer"></span>Cetak
            Surat</a>
    </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form mb-5" method="post"
                                action="/dashboard/layanan/surat_keterangan_belum_menikah/{{ $skbm->id }}"
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('nama_pengaju', $skbm->data_penduduk->nama) }}">
                                            @error('nama_pengaju')
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('nik') is-invalid @enderror"
                                                ...
                                                value="{{ old('nik', $skbm->data_penduduk->nik) }}">
                                            @error('nik')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('no_hp') is-invalid @enderror"
                                                ...
                                                value="{{ old('no_hp', $skbm->data_penduduk->no_hp) }}">
                                            @error('no_hp')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('jenis_kelamin', $skbm->data_penduduk->genders->jenis) }}">
                                            @error('jenis_kelamin')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ old('tanggal_lahir', $skbm->data_penduduk->tanggal_lahir) }}">
                                            @error('tanggal_lahir')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('agama') is-invalid @enderror"
                                                ...
                                                value="{{ old('agama', $skbm->data_penduduk->religions->agama) }}">
                                            @error('agama')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('pekerjaan', $skbm->data_penduduk->professions->kelompok) }}">
                                            @error('pekerjaan')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('pendidikan', $skbm->data_penduduk->education->pendidikan) }}">
                                            @error('pendidikan')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('perkawinan', $skbm->data_penduduk->marriages->status) }}">
                                            @error('perkawinan')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('warganegara', $skbm->data_penduduk->warganegara->setatus) }}">
                                            @error('warganegara')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('no_kk', $skbm->data_penduduk->no_kk) }}">
                                            @error('no_kk')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('alamat_pengaju', $skbm->data_penduduk->alamat) }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="oldImage1"
                                                value="{{ old('jenis_usaha', $skbm->poto_ktp) }}">
                                            @if ($skbm->poto_ktp)
                                                <div>
                                                    <a href="{{ asset('storage/' . $skbm->poto_ktp) }}" target="_blank">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="oldImage2" value="{{ $skbm->poto_kk }}">
                                            @if ($skbm->poto_kk)
                                                <div>
                                                    <a href="{{ asset('storage/' . $skbm->poto_kk) }}" target="_blank">
                                                        <button class="btn btn-success" type="button"> Cek Foto
                                                            KK</button>
                                                    </a>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="status_layanan_id">
                                                @foreach ($status_layanan as $status)
                                                    @if (old('category_id', $skbm->status_layanan_id) == $status->id)
