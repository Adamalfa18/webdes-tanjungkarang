                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="/dashboard/data/genders" class="mb-5"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="jenis" class="form-label">Jeni Kelamin</label>
                                    <input type="string" class="form-control @error('jenis') is-invalid @enderror"
                                        id="jenis" name="jenis" required autofocus>
                                </div>
                                <div class="mb-3">
                ...
                <table class="table table-striped table-sm">
                    ...
                    <tbody>
                        @foreach ($gender as $gend)
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="badge bg-warning border-0" data-bs-toggle="modal"
                                        data-bs-target="#modal-edit{{ $gend->id }}">
                            ...
                            <!-- Modal Edit-->
                            <div class="modal fade" id="modal-edit{{ $gend->id }}" data-bs-backdrop="static"
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="/dashboard/data/genders/{{ $gend->id }}"
