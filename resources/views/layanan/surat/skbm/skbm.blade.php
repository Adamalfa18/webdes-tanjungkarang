...
@section('container')
    ...
    @endif
    <div class="container">
        <h2>Tabel Pengajuan Surat keterangan Belum Menikah</h2>
    ...
    <div class="container">
        ...
        <div class="col-auto mb-3 posisi-btn">
            <a class="btn btn-success" href="/create/skbm">Tambah Pengajuan</a>
        </div>
    </div>
        ...
        <div class=" card col-lg-12">
            <div class="table-responsive col-lg-auto">
                <table class="table table-striped table-sm">
                    ...
                    <tbody>
                        @foreach ($surat_keterangan_belum_menikah as $skd)
                            <tr>
