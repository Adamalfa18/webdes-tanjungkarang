...
@section('container')
    <section id="multiple-column-form">
        <div class="container">
            <div class="mb-3">
                <a href="/layanan/surat/surat_keterangan_belum_menikah" class="btn btn-success"> <span
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form mb-5" method="post" action="/surat_keterangan_belum_menikah"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input placeholder="Tujuan Pengajuan Surat" type="text"
                                                    class="form-control @error('prihal') is-invalid @enderror"
                                                    id="prihal" name="prihal" required value="{{ old('prihal') }}">
                                                @error('prihal')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
