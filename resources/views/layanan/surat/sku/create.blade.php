...
@section('container')
    <section id="multiple-column-form">
        <div class="container">
            <div class="mb-3">
                <a href="/layanan/surat/surat_keterangan_usaha" class="btn btn-success"> <span
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form mb-5" method="post" action="/surat_keterangan_usaha"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-8">
                                            <div class="form-group">
                                                ...
                                                <input placeholder="Alamat Usaha" type="text"
