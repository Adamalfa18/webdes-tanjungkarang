...
@section('container')
    <section id="multiple-column-form">
        <div class="container">
            <div class="mb-3">
                <a href="/layanan/surat/surat_keterangan_meninggal" class="btn btn-success"> <span
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form mb-5" method="post" action="/surat_keterangan_meninggal"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input placeholder="Nama" type="text"
                                                    ...
                                                    id="nama_alm" name="nama_alm" required autofocus
                                                    value="{{ old('nama_alm') }}">
                                                @error('nama_alm')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input placeholder="Nik" type="number"
                                                    class="form-control @error('nik_alm') is-invalid @enderror"
                                                    id="nik_alm" name="nik_alm" required autofocus
                                                    value="{{ old('nik_alm') }}">
                                                @error('nik_alm')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input placeholder="Warganegara(wni/wna)" type="text"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input placeholder="Agama" type="text"
                                                    ...
                                                    id="agama_alm" name="agama_alm" required
                                                    value="{{ old('agama_alm') }}">
                                                @error('agama_alm')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="tanggal_meninggal" class="form-label">Tanggal
                                                    Meninggalr</label>
                                                <input placeholder="Tanggal Meninggal" type="date"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input placeholder="Tempat Meninggal" type="time"
